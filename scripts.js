let bills = {
  ...
  ring: 5,
  careCredit: 41,
  studentLoans: 421, // due on the 11th
};
...
const input = document.querySelector(".js-input-chickasaw").value;
const raw = Number(input) || bills.chickasaw;
return bills.chickasaw + 3;  
}
